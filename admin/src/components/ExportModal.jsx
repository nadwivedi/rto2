    ...
    try {
      ...
      for (const typeId of selectedTypes) {
        ...
        try {
          ...
          link.download = `${type.name.replace(/ /g, '_')}_${timestamp}.json`
  ...
  return (
    <>
      ...
      <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
        ...
        >
          {/* Header */}
          <div className='px-6 py-5 bg-gradient-to-r from-orange-50 via-red-50 to-pink-50 border-b border-gray-200 flex items-center justify-between'>
          ...
          <div className='p-6'>
            ...
            <div className='mb-4 pb-4 border-b border-gray-200'>
              <label className='flex items-center gap-3 p-3 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg cursor-pointer hover:from-orange-100 hover:to-red-100 transition-all border-2 border-orange-200'>
                <input
                  type='checkbox'
                  checked={allSelected}
          ...
          <div className='px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center rounded-b-2xl'>
            ...
            <div className='flex gap-3'>
              ...
              <button
                ...
                className='px-5 py-2.5 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-xl hover:shadow-lg font-semibold text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2'
              >
                {isExporting ? (
                  <>
