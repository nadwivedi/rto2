        ...
        <div className='bg-gradient-to-r from-orange-600 to-red-600 p-2 md:p-3 text-white flex-shrink-0'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-orange-100 text-xs md:text-sm mt-1'>Update temporary vehicle permit details</p>
            </div>
            <button
              onClick={onClose}
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4'>
                ...
                <div>
                  ...
                  {!vehicleError && !fetchingVehicle && formData.vehicleNumber && formData.permitHolderName && (
                    <p className='text-xs text-green-600 mt-1'>✓ Vehicle found - Details auto-filled</p>
                  )}
                </div>
