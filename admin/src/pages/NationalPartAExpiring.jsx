...
const NationalPartAExpiring = ({ setIsSidebarOpen }) => {
  ...
  const fetchPermits = async () => {
    try {
      ...
      const response = await nationalPermitAPI.getPartAExpiringSoon(params)

      console.log('Part A Expiring API Response:', response)
      ...
      console.error('Error fetching Part A expiring permits:', error)
        ...
        <div className='w-full px-3 md:px-4 lg:px-6 pt-20 lg:pt-20 pb-8'>
          ...
          <div className='mb-6'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                <h1 className='text-2xl md:text-3xl font-black text-gray-800'>Part A - Expiring Soon</h1>
                <p className='text-sm text-gray-600 mt-1'>National Permits (Part A) expiring within the next 30 days</p>
              </div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden'>
            <div className='px-6 py-5 bg-gradient-to-r from-orange-50 via-red-50 to-pink-50 border-b border-gray-200'>
              <div className='flex flex-col lg:flex-row gap-2 items-stretch lg:items-center'>
                ...
                <div className='relative flex-1 lg:max-w-md'>
                  <input
                    ...
                    className='w-full pl-11 pr-4 py-3 text-sm border-2 border-orange-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-400 transition-all bg-white shadow-sm'
                  />
                  <svg
                    className='absolute left-3.5 top-1/2 transform -translate-y-1/2 w-5 h-5 text-orange-400'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                  >
            ...
            <div className='overflow-x-auto'>
              <table className='w-full'>
                <thead className='bg-gradient-to-r from-orange-600 via-red-600 to-pink-600'>
                  <tr>
                ...
                <tbody className='divide-y divide-gray-200'>
                  {loading ? (
                    ...
                    filteredPermits.map((permit, index) => (
                      <tr key={permit.id} className='hover:bg-gradient-to-r hover:from-orange-50/50 hover:via-red-50/50 hover:to-pink-50/50 transition-all duration-200 group'>
                        <td className='px-4 py-4'>
                          <div className='flex items-center gap-3'>
                            <div className='flex-shrink-0 h-10 w-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md'>
                        ...
                        <td className='px-4 py-4'>
                          <span className='inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-orange-100 text-orange-700 border border-orange-200'>
                            {permit.status}
                          </span>
                        </td>
                      </tr>
                    ...
                    <tr>
                      <td colSpan='7' className='px-4 py-8 text-center'>
                        <div className='text-gray-400'>
                          ...
                          <p className='text-sm font-semibold text-gray-600'>No Part A permits expiring soon</p>
            ...
            {/* Pagination */}
            {totalItems > 0 && (
              <div className='px-6 py-4 border-t border-gray-200 bg-gradient-to-r from-orange-50 via-red-50 to-pink-50'>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-bold text-sm transition-all ${
                        currentPage === 1
                          ...
                          : 'bg-white border-2 border-orange-200 text-gray-700 hover:bg-orange-50 hover:border-orange-300 shadow-sm'
                      }`}
                    >
                      Previous
                    </button>
                            ...
                            <button
                              ...
                              className={`px-4 py-2 rounded-lg font-bold text-sm transition-all ${
                                currentPage === pageNumber
                                  ? 'bg-gradient-to-r from-orange-600 to-red-600 text-white shadow-lg transform scale-110'
                                  : 'bg-white border-2 border-orange-200 text-gray-700 hover:bg-orange-50 hover:border-orange-300 shadow-sm'
                              }`}
                            >
                              {pageNumber}
...
export default NationalPartAExpiring
