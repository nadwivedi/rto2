            ...
            <div className='px-6 py-5 bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 border-b border-gray-200'>
              <div className='flex flex-col lg:flex-row gap-2 items-stretch lg:items-center'>
                ...
                >
                  ...
                  <span className='hidden lg:inline'>Register New Vehicle</span>
                ...
                <div className='hidden lg:block overflow-x-auto'>
                  ...
                  <thead className='bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600'>
                    <tr>
                      ...
                      <th className='px-4 py-4 text-left text-xs font-bold text-white uppercase tracking-wide'>Engine No.</th>
                  ...
                  <tbody className='divide-y divide-gray-200'>
                    {filteredRegistrations.map((registration) => (
                      <tr key={registration._id} className='hover:bg-gradient-to-r hover:from-blue-50/50 hover:via-indigo-50/50 hover:to-purple-50/50 transition-all duration-200 group'>
                        ...
                        <td className='px-6 py-4'>
                          <div className='flex items-center gap-2'>
                            ...
                            {registration.chassisNumber && registration.chassisNumber !== 'N/A' && (
                              <button
                                onClick={() => handleCopyChassisNumber(registration.chassisNumber)}
                                className='p-1.5 text-blue-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all duration-200 cursor-pointer'
                                title='Copy Chassis Number'
                              >
                                <svg className='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z' />
                        ...
                        <td className='px-6 py-4'>
                          <div className='flex items-center gap-1.5 bg-gradient-to-r from-green-50 to-emerald-50 px-3 py-1.5 rounded-lg border border-green-200 w-fit'>
                            <svg className='w-3.5 h-3.5 text-green-500' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                              <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z' />
                              <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M15 12a3 3 0 11-6 0 3 3 0 016 0z' />
                            </svg>
                            <span className='text-[15px] font-mono font-semibold text-green-900'>{registration.engineNumber || 'N/A'}</span>
                          </div>
                        </td>
                        <td className='px-6 py-4'>
                          <div>
                ...
                <div className='bg-gradient-to-br from-indigo-50 to-purple-50 p-4 rounded-xl border-2 border-indigo-200'>
                  ...
                  <div className='grid grid-cols-2 gap-2'>
                    ...
                    {selectedRegistration.chassisNumber && (
                      <div className='bg-gradient-to-br from-blue-100 to-cyan-100 p-2.5 rounded-lg border-2 border-blue-300'>
                        <div className='text-xs font-semibold text-blue-700'>
                          Chassis Number
                        </div>
                        <div className='text-[15px] font-bold text-blue-900 mt-1 font-mono'>{selectedRegistration.chassisNumber}</div>
                      </div>
                    )}
                    {selectedRegistration.engineNumber && (
                      <div className='bg-gradient-to-br from-green-100 to-emerald-100 p-2.5 rounded-lg border-2 border-green-300'>
                        ...
                        <div className='text-[15px] font-bold text-green-900 mt-1 font-mono'>{selectedRegistration.engineNumber}</div>
                      </div>
                    )}
