                      ...
                      <div key={registration._id} className='bg-white rounded-lg shadow border border-gray-200 overflow-hidden hover:shadow-md transition-shadow'>
                        ...
                        <div className='bg-gray-50 p-3 flex items-start justify-between border-b border-gray-200'>
                          <div className='min-w-0 flex-1 mr-2'>
                            <div className='text-sm font-mono font-bold text-gray-900 mb-1'>
          ...
          <div className='bg-white rounded-xl md:rounded-3xl shadow-2xl w-full md:w-[95%] lg:w-[90%] xl:w-[85%] max-h-[98vh] md:max-h-[95vh] overflow-hidden animate-slideUp'>
            ...
            <div className='overflow-y-auto max-h-[calc(98vh-100px)] md:max-h-[calc(95vh-130px)] p-3 md:p-5'>
              <div className='grid grid-cols-1 lg:grid-cols-4 gap-3 md:gap-4'>
                ...
                <div className='bg-gradient-to-br from-blue-50 to-indigo-50 p-3 md:p-4 rounded-lg md:rounded-xl border-2 border-blue-200 lg:col-span-2'>
