...
const IssueBusPermitModal = ({ isOpen, onClose, onSubmit, initialData = null }) => {
  ...
  const handleChange = (e) => {
    ...
    const uppercaseFields = ['permitHolderName', 'fatherName', 'address', 'chassisNumber', 'engineNumber', 'routeFrom', 'routeTo']
      ...
      <div className='bg-white rounded-xl md:rounded-2xl shadow-2xl max-w-7xl w-full max-h-[95vh] overflow-hidden flex flex-col'>
        ...
        <div className='bg-gradient-to-r from-blue-600 to-indigo-600 p-3 md:p-4 text-white flex-shrink-0'>
          <div className='flex justify-between items-center'>
            <div>
              <h2 className='text-lg md:text-2xl font-bold'>Add New Bus Permit</h2>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className='flex flex-col flex-1 overflow-hidden'>
          <div className='flex-1 overflow-y-auto p-3 md:p-6'>
            ...
            <div className='bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-indigo-200 rounded-xl p-3 md:p-6 mb-4 md:mb-6'>
              ...
              {/* Three Column Row - Permit Holder Name, Mobile Number, Category */}
              ...
              {/* Two Column Grid - Route and Date Fields */}
              <div className='grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mt-3 md:mt-4'>
                {/* Route From */}
                <div>
                  <label className='block text-xs md:text-sm font-semibold text-gray-700 mb-1'>
                    Route From <span className='text-red-500'>*</span>
                  </label>
                  <input
                    type='text'
                    name='routeFrom'
...
export default IssueBusPermitModal
