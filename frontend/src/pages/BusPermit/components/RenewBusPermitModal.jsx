...
const RenewBusPermitModal = ({ isOpen, onClose, onSubmit, permitData }) => {
  ...
  // Pre-fill vehicle details when permitData is provided
  useEffect(() => {
    if (permitData && isOpen) {
      setFormData(prev => ({
        ...prev,
        vehicleNumber: permitData.vehicleNo || permitData.vehicleNumber || '',
        permitHolder: permitData.permitHolder || '',
  ...
  // Calculate valid to date (1 year from valid from for CG permit)
  useEffect(() => {
      ...
      if (parts.length === 3) {
        ...
        if (!isNaN(day) && !isNaN(month) && !isNaN(year) && year > 1900) {
          ...
          if (!isNaN(validFromDate.getTime())) {
            ...
            // CG permits are typically valid for 1 year
  ...
  const handleChange = (e) => {
    ...
    const uppercaseFields = ['permitNumber', 'permitHolder', 'vehicleNumber', 'fatherName']
  ...
  const handleSubmit = (e) => {
    ...
    if (onSubmit && permitData) {
      onSubmit({
        ...formData,
        oldPermitId: permitData._id || permitData.id
      })
    }
          ...
          <div className='flex-1 overflow-y-auto p-3 md:p-6'>
            ...
            {permitData && (
              <div className='bg-amber-50 border-l-4 border-amber-500 p-3 md:p-4 rounded mb-4 md:mb-6'>
                <div className='flex items-start gap-2'>
                  ...
                  <div>
                    <p className='text-sm md:text-base font-semibold text-amber-800'>Renewing Existing Bus Permit</p>
            ...
            <div className='bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-3 md:p-6 mb-4 md:mb-6'>
              <h3 className='text-base md:text-lg font-bold text-gray-800 mb-3 md:mb-4 flex items-center gap-2'>
                <span className='bg-green-600 text-white w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center text-xs md:text-sm'>1</span>
                Basic Details
              </h3>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4'>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                      permitData?.permitHolder ? 'bg-green-50' : ''
                    }`}
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <div className='relative'>
                    <input
                      ...
                      maxLength='10'
                      className='w-full px-3 py-2 border border-green-300 rounded-lg bg-green-50 font-mono font-semibold text-gray-700'
                      readOnly
                      required
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                      permitData?.fatherName ? 'bg-green-50' : ''
                    }`}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength='10'
                    className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                      permitData?.mobileNumber ? 'bg-green-50' : ''
                    }`}
                  />
                </div>
            ...
            <div className='bg-gradient-to-r from-gray-50 to-slate-50 border-2 border-gray-200 rounded-xl p-3 md:p-6'>
              <h3 className='text-base md:text-lg font-bold text-gray-800 mb-3 md:mb-4 flex items-center gap-2'>
                <span className='bg-gray-600 text-white w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center text-xs md:text-sm'>4</span>
                Notes (Optional)
              </h3>
...
export default RenewBusPermitModal
